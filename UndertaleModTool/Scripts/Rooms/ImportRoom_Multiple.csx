...
// Background layer imports fixed by AwfulNasty
// Dead ass option to choose multiple rooms by kota69th
...
bool IsWillingToImportOneRoom = ScriptQuestion("Are you importing one or multiple rooms?\nSelect Yes for one and No for multiple.");

if(!IsWillingToImportOneRoom)
{

ScriptMessage("Choose the directory where your rooms are.");
string roomsInputPath = PromptChooseDirectory();
if (roomsInputPath == null) throw new ScriptException("The rooms' path was not set.");

string[] roomspath = Directory.GetFiles(roomsInputPath);

UndertaleRoom newRoom = null;

int LoadedRooms = 0;
int NumberOfRoomsToLoad = roomspath.Length;
SetProgressBar("Starting Import...", "NA", 0, NumberOfRoomsToLoad);
foreach(string roomInputPath in roomspath)
{
    newRoom = new UndertaleRoom();
    LoadedRooms++;
    UpdateProgressBar("Importing...", Path.GetFileName(roomInputPath), LoadedRooms, NumberOfRoomsToLoad);
    ReadRoom(roomInputPath);
}
ScriptMessage("The script's job is done!");

return;
}

// This is only ran if the user is willing to import only one room.

ScriptMessage("Select the room you'd like to import.");
string roomInputPath = PromptLoadFile("Import which room?", "Json Files|*.json");
...
void ReadBackgrounds(ref Utf8JsonReader reader)
{
    ...
    while (reader.Read())
    {
        ...
        throw new ScriptException($"#1 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
    }
}
...
void ReadViews(ref Utf8JsonReader reader)
{
    ...
    while (reader.Read())
    {
        ...
        throw new ScriptException($"#2 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
    }
}
...
void ReadGameObjects(ref Utf8JsonReader reader)
{
    ...
    while (reader.Read())
    {
        ...
        throw new ScriptException($"#3 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
    }
}
...
void ReadTiles(ref Utf8JsonReader reader)
{
    ...
    while (reader.Read())
    {
        ...
        throw new ScriptException($"#4 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
    }
}
...
void ReadLayers(ref Utf8JsonReader reader)
{
    ...
    while (reader.Read())
    {
        ...
        throw new ScriptException($"#5 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
    }
}
...
void ReadAssetsLayer(ref Utf8JsonReader reader, UndertaleRoom.Layer newLayer)
{
    ...
    while (reader.Read())
    {
        ...
        throw new ScriptException($"#6 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
    }
...
bool ReadBool(ref Utf8JsonReader reader)
{
    while (reader.Read())
    {
        switch (reader.TokenType)
        {
            ...
            default: throw new ScriptException($"#7 ERROR: Unexpected token type. Expected Boolean - found {reader.TokenType}");
        }
    }
...
long ReadNum(ref Utf8JsonReader reader)
{
    while (reader.Read())
    {
        switch (reader.TokenType)
        {
            ...
            default: throw new ScriptException($"#8 ERROR: Unexpected token type. Expected Integer - found {reader.TokenType}");
        }
    }
...
float ReadFloat(ref Utf8JsonReader reader)
{
    while (reader.Read())
    {
        switch (reader.TokenType)
        {
            ...
            default: throw new ScriptException($"#9 ERROR: Unexpected token type. Expected Decimal - found {reader.TokenType}");
        }
    }
...
string ReadString(ref Utf8JsonReader reader)
{
    while (reader.Read())
    {
        switch (reader.TokenType)
        {
            ...
            default: throw new ScriptException($"#10 ERROR: Unexpected token type. Expected String - found {reader.TokenType}");
        }
    }
...
void ReadAnticipateJSONObject(ref Utf8JsonReader reader, JsonTokenType allowedTokenType)
{
    while (reader.Read())
    {
        ...
        if (reader.TokenType == allowedTokenType)
            return;
        throw new ScriptException($"#11 ERROR: Unexpected token type. Expected {allowedTokenType} - found {reader.TokenType}");
    }
