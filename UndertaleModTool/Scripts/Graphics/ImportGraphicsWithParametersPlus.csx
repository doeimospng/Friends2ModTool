...
static bool importAsSprite = false;
...
Otherwise, the image will be imported as a sprite, and allow you to select its origin point.
...
public void OffsetResult()
{
	...
	toolTip.SetToolTip(isSpecialBox, "Is special type? (required for animation speed to work)");
